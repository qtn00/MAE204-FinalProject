...
% traj{1} = ScrewTrajectory(T_se,T_se_stand_ini,tf ,dt,3);
% traj{2} = ScrewTrajectory(T_se_stand_ini,T_se_g_ini,tf,dt,3);
% traj{3} = ScrewTrajectory(T_se_g_ini,T_se_stand_ini,tf,dt,3);
% traj{4} = ScrewTrajectory(T_se_stand_ini,T_se_stand_fi,tf,dt,3);
% traj{5} = ScrewTrajectory(T_se_stand_fi,T_se_g_fi,tf,dt,3);
% traj{6} = ScrewTrajectory(T_se_g_fi,T_se_stand_fi,tf,dt,3);
